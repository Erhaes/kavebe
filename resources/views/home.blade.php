...
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-200">Kami melayani pengujian bahan bangunan serta standar bangunan menggunakan alat -alat yang tersertifikasi untuk semua kalangan.</p>
...
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="mx-auto text-center max-w-screen-md mb-8 lg:mb-16">
            ...
            <p class="text-gray-500 sm:text-xl dark:text-gray-200">Keunggulan kami.</p>
        </div>
        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-2 md:gap-12 md:space-y-0">
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-200">Pengujian dilakukan oleh tenaga ahli yang berpengalaman dan profesional dalam bidangnya.</p>
            </div>
            ...
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-200">Alat pengujian dikalibrasi setiap tahun untuk memastikan keakuratan hasil pengujian.</p>
            </div>
            ...
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-200">Kami melayani hingga 60 jenis pengujian yang berbeda.</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <p class="text-gray-500 dark:text-gray-200">Harga bersaing dan hasil sudah teruji. Dapat diskon bila membeli pengujian secara paket.</p>
            </div>
  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
        <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
            ...
            <p class="font-light text-gray-500 sm:text-xl dark:text-gray-200">Akreditasi dan Sertifikasi yang telah diperoleh Laboratorium Teknik SIpil Unsoed hingga saat ini.</p>
        </div> 
...
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto text-center max-w-screen-md mb-8 lg:mb-16">
            ...
            <p class="text-gray-500 sm:text-xl dark:text-gray-200">Hubungi kami untuk informasi pengujian atau kerjasama.</p>
        </div>
